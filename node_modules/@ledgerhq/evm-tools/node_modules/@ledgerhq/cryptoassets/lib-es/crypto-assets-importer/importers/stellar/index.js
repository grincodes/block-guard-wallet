...
export const importStellarTokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("importing stellar tokens...");
        const [stellarTokens, hash] = yield fetchTokens("stellar.json");
  ...
  boolean, // enableCountervalues
        ...
        fs.writeFileSync(`${filePath}.ts`, `${stellarTypeStringified}
