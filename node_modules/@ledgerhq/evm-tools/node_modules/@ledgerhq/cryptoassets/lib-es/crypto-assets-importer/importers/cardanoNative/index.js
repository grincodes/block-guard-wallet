...
export const importCardanoNativeTokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("importing cardanoNative tokens...");
        const [cardanoNativeTokens, hash] = yield fetchTokens("cardanoNative.json");
  ...
  boolean // disableCountervalue
        ...
        fs.writeFileSync(`${filePath}.ts`, `${cardanoNativeTypeStringified}
