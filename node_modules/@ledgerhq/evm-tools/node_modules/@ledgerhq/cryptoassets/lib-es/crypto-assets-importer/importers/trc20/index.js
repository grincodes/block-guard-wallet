...
export const importTRC20Tokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("importing trc20 tokens...");
        const [trc20tokens, hash] = yield fetchTokens("trc20.json");
  ...
  boolean?, // enableCountervalues
        ...
        fs.writeFileSync(`${filePath}.ts`, `${trc20TypeStringified}
