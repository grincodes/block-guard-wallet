...
`;
        ...
        expect(mockedFs).toHaveBeenNthCalledWith(2, "evm/1/erc20-hash.json", JSON.stringify("etagHash"));
        expect(mockedFs).toHaveBeenNthCalledWith(3, "evm/1/erc20-signatures-hash.json", JSON.stringify("signatureEtagHash"));
        expect(mockedFs).toHaveBeenNthCalledWith(4, "evm/1/erc20-signatures.json", JSON.stringify(evmTokenSignature));
