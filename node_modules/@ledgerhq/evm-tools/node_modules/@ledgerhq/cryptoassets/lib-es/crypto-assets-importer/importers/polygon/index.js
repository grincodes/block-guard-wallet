...
export const importPolygonTokens = (outputDir) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("importing polygon tokens...");
        const [polygonTokens, hash] = yield fetchTokens("polygon-erc20.json");
  ...
  (string | null)?, // legacy
        ...
        fs.writeFileSync(`${filePath}.ts`, `${tokenTypeStringified}
