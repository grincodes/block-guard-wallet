...
describe("import poylgon erc20", () => {
    beforeEach(() => {
        mockedAxios.mockImplementation(() => Promise.resolve({ data: poylgonErc20, headers: { etag: "etagHash" } }));
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
`;
        ...
        expect(mockedFs).toHaveBeenNthCalledWith(2, "polygon-erc20-hash.json", JSON.stringify("etagHash"));
